...
- 训练参数：batch_size=2，num_workers=0，num_train_steps=12000，log_interval=50
- 学习率调度：_optimizer.CosineDecaySchedule(warmup_steps=200, peak_lr=1e-5, decay_steps=4000, decay_lr=1e-5)
下文将按顺序，详细介绍各脚本、执行逻辑及常用指令。
